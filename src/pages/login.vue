    ...
    >
      ...
      <form @submit.prevent="logginIn" class="flex flex-col p-4 space-y-4">
        ...
        <div class="flex space-x-2">
          ...
          <button @click="signup(username, password)" class="w-1/2 py-2 text-purple-200 bg-purple-600 rounded-lg">
            Sing Up
          </button>
        </div>
        <button @click="google" class="flex justify-center py-2 bg-white rounded-lg hover:bg-gray-300">
